...
def main() -> None:
    ...
    for experiment in experiments:
        ...
        summary = run_stage2(
            ...
            innovation_winsor_lower=float(experiment.get("innovation_winsor_lower", shared.get("innovation_winsor_lower", 0.01))),
            innovation_winsor_upper=float(experiment.get("innovation_winsor_upper", shared.get("innovation_winsor_upper", 0.99))),
            innovation_high_quality_share=float(experiment.get("innovation_high_quality_share", shared.get("innovation_high_quality_share", 0.10))),
            ...
            regression_sample_thresholds=experiment.get("regression_sample_thresholds", shared.get("regression_sample_thresholds", [10, 5, 1])),
            regression_winsor_lower=float(experiment.get("regression_winsor_lower", shared.get("regression_winsor_lower", 0.01))),
            regression_winsor_upper=float(experiment.get("regression_winsor_upper", shared.get("regression_winsor_upper", 0.99))),
            regression_rd_year_min=int(experiment.get("regression_rd_year_min", shared.get("regression_rd_year_min", 2019))),
            regression_rd_year_max=int(experiment.get("regression_rd_year_max", shared.get("regression_rd_year_max", 2023))),
